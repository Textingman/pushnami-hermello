    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/privacy" className="text-[#272329] hover:text-[#272329] px-3 py-2 rounded-md text-sm font-medium">
                  Privacy
                </Link>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            To exercise these rights, please contact us at <a href="mailto:support@tryhermello.com" className="text-[#272329] hover:text-[#4A234F]">support@tryhermello.com</a>.
          </p>
