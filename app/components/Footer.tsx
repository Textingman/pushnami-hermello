...
export default function Footer() {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: '#3B0764' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Hermello</h3>
            <p style={{ color: '#DDD6FE' }}>
              Connect, engage, and grow with your team.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#DDD6FE' }} className="hover:text-white">Get Team Updates</Link></li>
            </ul>
          </div>
          <div>
