      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            Hermello is committed to responsible and transparent SMS communications. This page describes how and when we use SMS (text messaging) to communicate with our users.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-600"><strong>Phone:</strong> <a href="tel:+18556106247" className="text-[#272329] hover:text-[#4A234F]">(855) 610-6247</a></p>
          </div>
