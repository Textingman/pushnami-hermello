      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            By accessing or using Hermello&apos;s loyalty tracking platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service, including businesses, developers, and end users.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-gray-600 mb-6">
            Hermello provides a customer engagement and loyalty tracking platform that allows businesses to create, manage, and optimize loyalty programs. The Service includes:
          </p>
          ...
          <p className="text-gray-600 mb-6">
            You are solely responsible for fulfilling any rewards, discounts, or benefits promised to your customers through your loyalty program. Hermello is not responsible for any rewards or benefits offered through your program.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            The Service and all content, features, and functionality are owned by Hermello and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, VOLT INTERNAL COMMS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            You agree to indemnify, defend, and hold harmless Hermello and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
          ...
          <p className="text-gray-600 mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and Hermello regarding the Service and supersede all prior agreements.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            Hermello is committed to responsible and transparent SMS communications. This section describes how and when we use SMS (text messaging) to communicate with our users.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">16.2 What We Send</h3>
          <p className="text-gray-600 mb-6">
            Hermello <strong>only sends alert related text messages</strong> via SMS. We do not send marketing, promotional, or advertising messages of any kind.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">16.3 Opt-In</h3>
          <p className="text-gray-600 mb-6">
            SMS notifications are optional. You may opt in to receive transactional SMS messages during the account registration process by checking the SMS opt-in box. Opting in is not required to use the Hermello platform.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            Message and data rates may apply depending on your mobile carrier and plan. Message frequency varies based on your account activity. Hermello is not responsible for any charges incurred from your mobile carrier.
          </p>
