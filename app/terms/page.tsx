    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section className="py-12" style={{ backgroundColor: '#F5F7FA' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg" style={{ color: '#6B7280' }}>Last Updated: July 19, 2026</p>
        </div>
      </section>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            By accessing or using Hermello's service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service.
          </p>
          <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#1F2937' }}>2. Description of Service</h2>
          <p className="mb-6" style={{ color: '#6B7280' }}>
            Hermello provides an AI-powered information and education service accessible through www.hermello.com. The Service is intended for informational purposes only and does not constitute professional advice.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            Hermello shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service.
          </p>
